...
function buildEmail(client, mailingMonthLabel, deadline, imageUrls, sessionId, bodyTemplate) {
  ...
  return '<!DOCTYPE html><html><head><meta charset="UTF-8"></head>' +
    ...
    (process.env.LOGO_URL ? '<img src="' + process.env.LOGO_URL + '" alt="The Texan Local" style="width:160px;height:auto;display:block;margin:8px 0">' : '<div style="font-family:Georgia,serif;font-size:18px;color:#BF0D3E;font-weight:700;margin:8px 0">The Texan Local</div>') +
